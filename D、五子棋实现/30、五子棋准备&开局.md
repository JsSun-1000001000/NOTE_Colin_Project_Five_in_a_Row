...
==**解决：进入目标文件，把头文件改成自己工程下的目录
**==
[Qt自定义控件提升，头文件找不能的问题_qt自定义控件提升后找不到类-CSDN博客](https://blog.csdn.net/u013253181/article/details/104553125)

==**或者取消QWidge提升，重新修改 写好类名后，手动更改类地址**==
